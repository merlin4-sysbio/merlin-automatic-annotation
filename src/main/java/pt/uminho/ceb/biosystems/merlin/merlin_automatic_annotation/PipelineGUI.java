...
public class PipelineGUI extends javax.swing.JDialog implements InputGUI{
    ...
    private String inputColumn4; //CheckBox reviewed
    private String inputAcceptDefault;
    
	private ArrayList<String> listInputColumn1 = new ArrayList<String>(); //ComboBox species/genus
	private ArrayList<String> listInputColumn2 = new ArrayList<String>(); //ComboBox list of species/genus available
	private ArrayList<Double> listInputColumn3 = new ArrayList<Double>(); //TextField e-value
	private ArrayList<String> listInputColumn4 = new ArrayList<String>(); //CheckBox reviewed
...
//    	new EvaluatorEA(blastDatabase, listInputColumn1, listInputColumn2, listInputColumn3, listInputColumn4, inputAcceptDefault, homologyDataContainer);
    	...
    	try {
			ParamSpec[] paramsSpec = new ParamSpec[]{
					...
					new ParamSpec("listInputColumn1", String.class, listInputColumn1, null),
					new ParamSpec("listInputColumn2", String.class, listInputColumn2, null),
			...
			for (@SuppressWarnings("rawtypes") OperationDefinition def : Core.getInstance().getOperations()){
				if (def.getID().equals("operations.EvaluatorEnzymesAnnotation.ID")){
...
//		jCheckBox3.setEnabled(false);
	...
	private void getInput() {
		...
		if(jCheckDefaultAnnotation.isSelected()) {
			inputAcceptDefault = "1";
					
		} else {
			inputAcceptDefault = "0";
		}
	}
